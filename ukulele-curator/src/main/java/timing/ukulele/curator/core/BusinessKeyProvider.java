...
import timing.ukulele.curator.annotation.ZookeeperLockKey;
...
public class BusinessKeyProvider {
    ...
    public String getKeyName(ProceedingJoinPoint joinPoint,ZookeeperLock lock) {
    ...
    private List<String> getParameterKey(Parameter[] parameters, Object[] parameterValues) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            if (parameters[i].getAnnotation(ZookeeperLockKey.class) != null) {
                ZookeeperLockKey keyAnnotation = parameters[i].getAnnotation(ZookeeperLockKey.class);
